...
func translateFile(baseName, lang string) {
	...
	// Restauração do progresso individual detalhado
	...
	for scanner.Scan() {
		...
		if strings.HasPrefix(line, "msgid ") {
			...
			if !quietFlag && !verboseFlag {
				// Mostra progresso individual por idioma
