/*
    ...
    Updated:   seg 12 jan 2026 23:45:00 -04
    Version:   2.1.11
*/
...
// ... [O restante do código (Markdown, JSON, Cache, Utils) permanece idêntico à v2.1.31] ...
...
func checkDependencies() {
	for _, bin := range []string{"xgettext", "msginit", "msgfmt", "trans", "gettext", "ngettext"} {
