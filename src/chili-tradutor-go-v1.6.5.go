...
// Idiomas padrão (Top 5)
var defaultLanguages = []string{"pt-BR", "pt-PT", "en", "es", "fr"}
...
func main() {
	...
	// Lógica de seleção de idiomas (Top 5 vs All vs List)
