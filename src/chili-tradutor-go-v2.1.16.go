/*
    ...
    Updated:   sex 16 jan 2026 00:40:00 -04
    Version:   2.1.16
*/
...
func stampPotHeader(path string, lang string) {
	...
	if found {
		...
		// Caso não ache as referências, limpa o lixo e injeta o header
...
func writeMsgfmtToMo(base, lang string) {
	...
	// Flag -f para aceitar traduções mista/fuzzy
...
func translateFile(baseName, lang string) {
	...
	// Carimba o Header com o idioma correto antes de processar
