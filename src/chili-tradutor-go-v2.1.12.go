/*
    ...
    Updated:   ter 13 jan 2026 00:15:00 -04
    Version:   2.1.12
*/
...
func runFullSelfTest() {
	...
	if _, err := os.Stat("doc/test_integrity-es.md"); err == nil {
		fmt.Println(green("OK"))
		os.Remove(mdFile); os.Remove("doc/test_integrity-es.md")
	} else {
		fmt.Println(red("FALHA"))
	}
	...
	if _, err := os.Stat("yml/test_integrity-fr.yml"); err == nil {
		fmt.Println(green("OK"))
		os.Remove(ymlFile); os.Remove("yml/test_integrity-fr.yml")
	} else {
		fmt.Println(red("FALHA"))
	}
	...
	if _, err := os.Stat("pot/test_integrity.pot"); err == nil {
		fmt.Println(green("OK"))
		os.Remove(pyFile); os.Remove("pot/test_integrity.pot")
	} else {
		fmt.Println(red("FALHA"))
	}
...
func callUniversalTranslator(text, lang string) string {
	...
	mu.Lock()
	if cacheData == nil { cacheData = make(map[string]map[string]CacheEntry) }
