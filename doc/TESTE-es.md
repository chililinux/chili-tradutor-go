...
* Traducción paralela: procesa varios idiomas simultáneamente utilizando Goroutines (ajustable mediante -j).
...
* Markdown: genera versiones traducidas en ./doc/ (por ejemplo: README-en.md).
...
* Actualización automática: cada vez que se encuentra un elemento en el caché, se actualiza su marca de tiempo de "Último uso", lo que lo protege de futuros borrados automáticos.
